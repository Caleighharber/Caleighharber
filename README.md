...
|   | <div align="center">**Role:&nbsp;&nbsp;Data Analyst**</div> |
| Upwork - Data Analyst | 1. Developed interactive dashboards in Power BI and Tableau to visualize sales trends, inventory levels, and customer behavior, enabling stakeholders to make data-driven decisions and improving operational efficiency by 18%. <br>
2. Built and optimized SQL queries to extract, transform, and analyze large datasets, identifying key insights that led to a 15% reduction in overstock and improved inventory turnover. <br>
3. Designed and implemented machine learning models (e.g., regression, classification) to predict customer churn and product demand, increasing forecast accuracy by 20% and supporting better resource allocation. <br>
4. Automated data cleaning and preprocessing pipelines using Python, reducing manual effort by 30% and ensuring high-quality data for analysis and reporting. |
